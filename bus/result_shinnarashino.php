    ...
    <body>
      ...
      require 'db.php';                                                # 接続
        ...
        foreach ($result as $row) {
                ...
                if($sw == "平日" AND ($st < '07:19:00' OR $st > '20:40:00')){
                  header("Location:error.html");
                }elseif($sw == "土曜日" AND ($st < '07:19:00' OR $st > '19:40:00')){
                  header("Location:error.html");
                }elseif($sw == "日曜・祝日・休日" AND ($st < '07:59:00' OR $st > '17:00:00')){
                  header("Location:error.html");
                }else{
                  echo "<p>", $sd, '（', $sw, 'ダイヤ）', $st, '　新習志野発', "</p>";
                }              
         }
